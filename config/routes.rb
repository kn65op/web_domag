...
#	end
    ...
    match "thing/view/:id" => "things#view", :as => "view_thing"
    ...
    match "manufacturer/view/:id" => "manufacturers#view", :as => "view_manufacturer"
    ...
    match "shop/view/:id" => "shops#view", :as => "view_shop"
